...
class PageManager extends React__default['default'].PureComponent {
    ...
    render() {
        ...
        return (React__default['default'].createElement(IonLifeCycleContext.Consumer, null, (context) => {
            ...
            return (React__default['default'].createElement("div", Object.assign({ className: className ? `${className} ion-page` : `ion-page`, ref: this.ionPageElementRef }, props), children));
        }));
    }
    static get contextType() {
        return StackContext;
